...
if __name__ == '__main__':
    ...
    # 成像结果路径
    WignerPath = '../../Wigner_Sim/210629/fishR_ballG_1750_6_ReOrder_ReAlign15d6_Cut721_Cx956Cy956_2'
    # 波前导入路径
    ...
    SavePath_root = SavePath_root_up + 'PipeLineOptSync_v34x_f0_24Angle_2/'
